 ...
 */
static pid_t get_first_empty(void) {
 ...
 */
static exec_state_t create_process(
    pid_t process_pid,
 ...
 */
static exec_state_t kill_process(pid_t to_kill) {
...
static inline exec_state_t standard_scheduler(void) {
    current_process = MAX_PRIORITY_PROCESS;
 ...
 */
static inline exec_state_t scheduler_loop(void) {   
